...
<div class="col-lg-6">
  <div class="row">
    ...
    <div class="col-md-6 mb-4">
      <div class="small-box text-white p-3 rounded shadow-sm" style="background: linear-gradient(135deg, #007bff, #0056b3);">
        <div class="inner">
          <h3><?= $total_users; ?></h3>
          <p>Data Users</p>
        </div>
        <div class="icon"><i class="fas fa-users"></i></div>
        <a href="users.php" class="d-block text-center py-2 mt-3 rounded" style="background-color: rgba(0,0,0,0.2); color: #fff;">
    ...
    <!-- Barang -->
    <div class="col-md-6 mb-4">
      <div class="small-box text-white p-3 rounded shadow-sm" style="background: linear-gradient(135deg, #6c757d, #343a40);">
        <div class="inner">
          <h3><?= $total_barang; ?></h3>
          <p>Total Barang</p>
        </div>
        <div class="icon"><i class="fas fa-box-open"></i></div>
        <a href="barang.php" class="d-block text-center py-2 mt-3 rounded" style="background-color: rgba(0,0,0,0.2); color: #fff;">
          Lihat Detail <i class="fas fa-arrow-circle-right"></i>
        </a>
      </div>
    </div>
